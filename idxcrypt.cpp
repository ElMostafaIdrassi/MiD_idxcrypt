/*
 * A fork of idxcrypt by Mounir IDRASSI, a small utility to encrypt/decrypt files 
 * using AES-CBC-256 and strong password key derivation.
 *
 * The AES-CBC-256 key is derived from password using PBKDF2 with 500000 iterations.
 *
 * This fork is compatible with Windows and Linux and doesn't use Windows Crypto API.
 * 
